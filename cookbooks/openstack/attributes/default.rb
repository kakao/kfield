...
default[:openstack][:domk][:domain][:ns] = 'ptom077.dakao.io'
...
default[:openstack][:domk][:azro][:azro_url] = 'http://azr.9rum.cc'
default[:openstack][:domk][:azro][:azro_domain] = '9rum.cc'
default[:openstack][:domk][:azro][:azro_subdomain] = 's1.ccc'
default[:openstack][:domk][:azro][:azro_user] = 'infra'
default[:openstack][:domk][:azro][:azro_passwd] = 'ThsutleoWkd!9'
